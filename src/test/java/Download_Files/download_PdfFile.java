...
public class download_PdfFile {

	public static void main(String[] args) throws InterruptedException {
		
		// *** When we click on download PDF button, it will open as view in browser ***
...
//		WebDriver driver = new EdgeDriver(options);
		...
		// For Complete List of MIME Type (i,e., Media type and subtypes)
		// https://www.sitepoint.com/mime-types-complete-list/
		
//		FirefoxProfile profile = new FirefoxProfile();
//		profile.setPreference("pdfjs.disabled", true); // for PDF download
//		profile.setPreference("browser.helperApps.neverAsk.saveToDisk", "application/pdf,application/msword"); // Specify media type(mime type)
